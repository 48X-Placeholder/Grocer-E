...
<body>
    ...
    <section>
        ...
        <img src="<? echo SITE_URL.'assets/images/indexphoto2.jpg'?>" alt="Child helping with groceries" class="full-width-image">
        </div>
        ...
        <div class="image-container">
        <img src="<? echo SITE_URL.'assets/images/indexphoto1.jpg'?>" alt="Woman organizing pantry" class="full-width-image">
        </div>
        ...
        <div class="image-container">
        <img src="<? echo SITE_URL.'assets/images/indexphoto3.jpg'?>" alt="Person placing vegetables in fridge" class="full-width-image">
        </div>
    </section>
	
	<footer class="footer">
        <a href="<? echo SITE_URL.'about'?>">About Us</a>
    </footer>
</body>
</html>