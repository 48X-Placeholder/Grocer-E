...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["password"], $_POST["confirm_password"]) && $valid && $userId) {
...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo SITE_URL . 'assets/images/grocer-e_favicon.png'; ?>">
</head>
<body>
